...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'bulletin.list.label', default: 'Staff')}"/>
                    ...
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col col-xs-6">
                                <h3 class="panel-title">Saved Bulletins</h3>
                            </div>

                            <div class="col col-xs-6 text-right">
                                <a role="button" class="btn btn-sm btn-primary btn-create"
                                   href="${createLink(action: 'bulletin')}">Create New</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-body">
                        <table class="table table-striped table-bordered table-list">
                            ...
                            <g:each in="${bulletins}" var="bulletin">
                                <tr>
                                    <td align="center">
                                        <a class="btn btn-default" style="max-width: 35px" href="edit/${bulletin.id}">
                                            <em class="fa fa-pencil"></em></a>
                                        <a class="btn btn-danger delete" style="max-width: 35px" id="${bulletin.id}">
                                            <em class="fa fa-trash"></em></a>
                                    </td>
                                    <td class="hidden-xs">${bulletin.id}</td>
...
<script type="application/javascript">
    $(document).ready(function () {
        $('.delete').on('click', function (e) {
            ...
            if(i) {
                window.location.replace('bulletinDelete/' + e.currentTarget.id)
            }
        });
    });
</script>
