...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'staff.users.label', default: 'Staff')}"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col col-xs-6 text-right">
                                <a role="button" class="btn btn-sm btn-primary btn-create"
                                   href="${createLink(action: 'newAdmin')}">Create New</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-body">
                        <table class="table table-striped table-bordered table-list">
                            ...
                            <tr>
                                ...
                                <g:sortableColumn property="llIP" title="Login IP"/>
                            </tr>
                            </thead>
                            <tbody>
                            <g:each in="${users}" var="user">
                                <tr>
                                    <td align="center">
                                        <a class="btn btn-default" style="max-width: 35px" href="edit/${user.id}">
                                            <em class="fa fa-pencil"></em></a>
                                        <a class="btn btn-danger delete" style="max-width: 35px" id="${user.id}">
